...
(function($, undefined) {
   ...
   var linkDefaults = {
      'open': {
         ...
         'icon': '<span class="ui-icon ui-icon-search"></span',
  ...
  /**
   ...
   options: {
      ...
      noneSelectedText: ' ', // (string | null) The text to show in the button where nothing is selected.  Set to null to use the native select's placeholder text.
      selectedText: '',    // (string) A "template" that indicates how to show the count of selections in the button.  The "#'s" are replaced by the selection count & option count.
